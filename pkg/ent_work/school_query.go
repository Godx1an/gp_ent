...
func (sq *SchoolQuery) Modify(modifiers ...func(s *sql.Selector)) *SchoolSelect {
...
// Modify adds a query modifier for attaching custom logic to queries.
func (ss *SchoolSelect) Modify(modifiers ...func(s *sql.Selector)) *SchoolSelect {
